...
detected_total="${LOCAL_INFERENCE_CPU_TOTAL_THREADS:-${WEB_OSINT_CPU_TOTAL_THREADS:-}}"
...
reserved="${LOCAL_INFERENCE_CPU_RESERVED_THREADS:-${WEB_OSINT_CPU_RESERVED_THREADS:-2}}"
...
export LOCAL_INFERENCE_CPU_TOTAL_THREADS="$detected_total"
export LOCAL_INFERENCE_CPU_RESERVED_THREADS="$reserved"
export LOCAL_INFERENCE_CPU_EFFECTIVE_THREADS="$effective"
# Compatibility for clients that still read the older Web OSINT names during migration.
...
affinity_enabled="${LOCAL_INFERENCE_CPU_GUARD_AFFINITY:-${WEB_OSINT_CPU_GUARD_AFFINITY:-1}}"
affinity_range=""
